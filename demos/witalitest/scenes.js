        ...
        for(var a=0,al = area.length;a<al;a++){
            ...
            if(background > 0){
                ...
                if(tiles[tilename] === undefined){
                	...
                	tile = Crafty.e("Render, Spatial, Texture").texture("img/grassland.png", { x: 12*background, y: 90, frames: 1 });//Mark the components as Tiles with Tile component
                	tile.attr({w: 128, h: 128})
            ...
            if(object > 0){
                ...
                if(tiles[tilename] === undefined){
                    ...
                    tile = Crafty.e("2D","DOM","Tile",object);//Mark the components as Tiles with Tile component
